...
export function Users() {
  ...
  const [selectedUser, setSelectedUser] = useState<UserTableData>(
    {} as UserTableData,
  )
  ...
  function handleChangeSelectedUserName(
  ...
  function handleChangeSelectedUserEmail(
    event: React.ChangeEvent<HTMLInputElement>,
  ) {
    const newUser = {
      ...selectedUser,
  ...
  function onOpenModal(selectedId: number) {
    const selectedUserData = tableData.filter(
      (unit) => unit.key === selectedId,
    )[0]
              ...
              <div>
                ...
                >
                  ...
                  <Input
                    ...
                    onChange={handleChangeSelectedUserEmail}
                  />
                </Modal>
                <Confirm
                  title={`Excluir usuário ${record.name}?`}
